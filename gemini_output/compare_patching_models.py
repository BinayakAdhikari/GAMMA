...
def compare_models_on_quixbugs(
    ...
    output_report_path=r"E:\Marburg Uni\Third Semester\GAMMA Seminar\GAMMA\gemini_output\model_patching_comparison_report.md",
    output_csv_path=r"E:\Marburg Uni\Third Semester\GAMMA Seminar\GAMMA\gemini_output\patching_comparison_data.csv"
):
    report_content = []
    csv_data = []
